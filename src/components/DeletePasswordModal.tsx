...
export const DeletePasswordModal: React.FC<DeletePasswordModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className="bg-white border border-neutral-200/80 rounded-2xl w-full max-w-md shadow-2xl relative z-10 overflow-hidden transform transition-all duration-300 scale-100 flex flex-col">
        {/* Header */}
        <div className="p-5 border-b border-neutral-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-bold text-neutral-900 font-sans tracking-tight">Security Verification</h3>
              <p className="text-[10px] text-neutral-400 font-medium">Authentication required for deletion</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
          <div className="bg-red-50/50 border border-red-100 rounded-xl p-4 flex gap-3 text-red-800">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-[11px] text-red-700/90 leading-relaxed font-sans">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-3 pr-10 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-xs focus:bg-white focus:outline-none focus:ring-1.5 focus:ring-red-500 focus:border-red-500 transition-all font-sans"
                disabled={isDeleting}
                autoFocus
              />
              <button
          ...
          <div className="flex items-center gap-2 mt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-2.5 bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 text-neutral-800 rounded-xl text-xs font-bold transition-all cursor-pointer"
              disabled={isDeleting}
            >
              Cancel
            </button>
