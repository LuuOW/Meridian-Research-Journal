              ...
              <div className={`p-4 rounded-2xl border flex items-center justify-between transition-all ${
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    syncStatus.configured ? "bg-emerald-500/10 text-emerald-600" : "bg-neutral-200/50 text-neutral-400"
                  }`}>
                  ...
                  <div>
                    <h5 className="text-xs font-extrabold text-neutral-800 uppercase tracking-wide">
                ...
                {syncStatus.configured && (
                  <span className="text-[9px] font-mono tracking-wider font-extrabold uppercase bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded border border-emerald-200">
                    ACTIVE
                  </span>
                )}
              </div>
